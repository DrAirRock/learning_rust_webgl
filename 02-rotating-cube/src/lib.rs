...
pub fn start() -> Result<(), JsValue> {
    ...
    context.vertex_attrib_pointer_with_i32(pos_attrib_loc, // Attribute location
                                           ...
                                           6 * std::mem::size_of::<f32>() as i32, // Size of individual vertex 
    ...
    mat4::look_at(&mut view_matrix, &[0., 0., -8.], &[0., 0., 0.], &[0., 1., 0.]);
    mat4::perspective(&mut proj_matrix, to_radian(45.), (canvas.client_width() / canvas.client_height()) as f32, 0.1, Some(1000.0));
    ...
    *g.borrow_mut() = Some(Closure::wrap(Box::new(move || { 
        angle = performance.now() as f32 / 1000_f32 / 6_f32 * 2_f32 * PI;
